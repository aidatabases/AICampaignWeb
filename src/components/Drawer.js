        ...
        <div>
          <div className="drawer-nav" onClick={() => setSocial(!social)}>
            ...
            <FontAwesomeIcon
              ...
              rotation={social ? 0 : 180}
            />
          </div>
          {social && (
            <div>
              <NavLink activeClassName="drawer-nav-active" to="/social/update">
                <div className="drawer-nav sub-nav drawer-nav-text">
                  Post an Update
                </div>
              </NavLink>
              <NavLink
                activeClassName="drawer-nav-active"
                to="/social/liveStream"
              >
                <div className="drawer-nav sub-nav drawer-nav-text">
                  Live Streaming
                </div>
